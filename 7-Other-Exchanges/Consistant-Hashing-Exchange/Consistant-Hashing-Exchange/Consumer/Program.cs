...
channel.QueueBind("letterbox1", "samplehashing", "1");//last parameter is hash space allocation, 1 of 4 is 25% of hash space
channel.QueueBind("letterbox2", "samplehashing", "3");//last parameter is hash space allocation, 3 of 4 is 75% of hash space
